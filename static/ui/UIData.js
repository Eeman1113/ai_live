...
export const UI_STARGAZER_SETUP = "UI_STARGAZER_SETUP";
...
export const UI_STARMAP_STAR_MIN_SIZE = "UI_STARMAP_STAR_MIN_SIZE";

export const UI_SH_STYLE_SIZE_A = "UI_SH_STYLE_SIZE_A";
export const UI_SH_STYLE_SIZE_B = "UI_SH_STYLE_SIZE_B";
export const UI_SH_STYLE_SIZE_C = "UI_SH_STYLE_SIZE_C";

export const UI_SH_STYLE_BRIGHTNESS_A = "UI_SH_STYLE_BRIGHTNESS_A";
export const UI_SH_STYLE_BRIGHTNESS_B = "UI_SH_STYLE_BRIGHTNESS_B";
export const UI_SH_STYLE_BRIGHTNESS_C = "UI_SH_STYLE_BRIGHTNESS_C";


export const UI_SH_MINMODE = "UI_SH_MINMODE";
export const UI_SH_TARGETNUMSTARS = "UI_SH_TARGETNUMSTARS";
export const UI_SH_MINLUMINENCE = "UI_SH_MINLUMINENCE";
export const UI_SH_MAXLUMINENCE = "UI_SH_MAXLUMINENCE";
export const UI_SH_MINSIZE = "UI_SH_MINSIZE";
export const UI_SH_MAXSIZE = "UI_SH_MAXSIZE";
export const UI_SH_COLORSHIFT = "UI_SH_COLORSHIFT";

export const UI_SH_STYLE = "UI_SH_STYLE";
export const UI_SH_STYLE_PRESETS = "UI_SH_STYLE_PRESETS";

export const UI_SH_DISTPOWERMULT = "UI_SH_DISTPOWERMULT";
...
export const UI_STARMAP_FEH_MIN_VALUE = "UI_STARMAP_FEH_MIN_VALUE";
export const UI_STARMAP_FEH_WINDOW_SIZE = "UI_STARMAP_FEH_WINDOW_SIZE";
export const UI_STARMAP_FEH_POW = "UI_STARMAP_FEH_POW";
export const UI_STARMAP_VIEWMODE = "UI_STARMAP_VIEWMODE";

export const UI_AA_MODE_LABEL = "UI_AA_MODE_LABEL";
export const UI_AA_MODE_PLOT = "UI_AA_MODE_PLOT";
export const UI_AA_MODE_STYLE = "UI_AA_MODE_STYLE";
export const UI_AA_MODE_SETUP = "UI_AA_MODE_SETUP";
export const UI_AA_MODE_SELECT = "UI_AA_MODE_SELECT";

export const UI_AA_SETUP_COLORMODE = "UI_AA_SETUP_COLORMODE";
export const UI_AA_SETUP_MIN = "UI_AA_SETUP_MIN";
export const UI_AA_SETUP_WINDOW_SIZE = "UI_AA_SETUP_WINDOW_SIZE";
export const UI_AA_SETUP_POW = "UI_AA_SETUP_POW";
export const UI_AA_SETUP_MULT = "UI_AA_SETUP_MULT";
export const UI_AA_SETUP_SELECT_MULT = "UI_AA_SETUP_SELECT_MULT";
export const UI_AA_SETUP_DISPLAYTYPE_MIN = "UI_AA_SETUP_DISPLAYTYPE_MIN";
export const UI_AA_SETUP_DISPLAYTYPE_WINDOW = "UI_AA_SETUP_DISPLAYTY_WINDOWPE";
export const UI_AA_SETUP_DISPLAYTYPE_MAX = "UI_AA_SETUP_DISPLAYTYPE_MAX";
export const UI_AA_SETUP_DISPLAYTYPE_MULT = "UI_AA_SETUP_DISPLAYTYPE_MULT";
export const UI_AA_SETUP_DISPLAYTYPE_NAME_MULT = "UI_AA_SETUP_DISPLAYTYPE_NAME_MULT";

export const UI_SH_SUBDIVISION_SIZE = "UI_SH_SUBDIVISION_SIZE";
export const UI_SH_STARS_PER_BUCKET = "UI_SH_STARS_PER_BUCKET";
...
export const UI_CAMERA_CENTER_SELECT_POINT = "UI_PALETTE_CENTER_SELECT_POINT";
export const UI_CAMERA_CENTER_SELECT_OFFSET = "UI_CAMERA_CENTER_SELECT_OFFSET";
...
export const UI_AA_PLOT_ACTIVE = "UI_AA_PLOT_ACTIVE";

export const UI_AA_PLOT_CONFIGURE = "UI_AA_PLOT_CONFIGURE";
export const UI_AA_PLOT_PARAMS = "UI_AA_PLOT_PARAMS";
export const UI_AA_PLOT_WIDTH = "UI_AA_PLOT_WIDTH";
export const UI_AA_PLOT_HEIGHT = "UI_AA_PLOT_HEIGHT";
export const UI_AA_PLOT_MAXPOINTS = "UI_AA_PLOT_MAXPOINTS";
export const UI_AA_PLOT_XKEY = "UI_AA_PLOT_XKEY";
export const UI_AA_PLOT_YKEY = "UI_AA_PLOT_YKEY";
export const UI_AA_PLOT_ZOOM_X = "UI_AA_PLOT_ZOOM_X";
export const UI_AA_PLOT_ZOOM_Y = "UI_AA_PLOT_ZOOM_Y";
export const UI_AA_PLOT_OFFSET_X = "UI_AA_PLOT_OFFSET_X";
export const UI_AA_PLOT_OFFSET_Y = "UI_AA_PLOT_OFFSET_Y";
export const UI_AA_PLOT_SELECTRADIUS = "UI_AA_PLOT_SELECTRADIUS";
export const UI_AA_PLOT_SELECT_NAMED_STARS = "UI_AA_PLOT_SELECT_NAMED_STARS";

export const UI_AA_SELECT_FILTERMODE_GRAPH = "UI_AA_SELECT_FILTERMODE_GRAPH";
export const UI_AA_SELECT_FILTERMODE_STARS = "UI_AA_SELECT_FILTERMODE_STARS";
export const UI_AA_SELECT_FILTERMODE_GRAPH_PREPARED = "UI_AA_SELECT_FILTERMODE_GRAPH_PREPARED";
export const UI_AA_LABEL_STARS = "UI_AA_LABEL_STARS";
export const UI_AA_LABEL_GRAPH = "UI_AA_LABEL_GRAPH";
export const UI_AA_PLOT_HIDEGRAPH = "UI_AA_PLOT_HIDEGRAPH";
export const UI_AA_PLOT_HIDECONTROLS = "UI_AA_PLOT_HIDECONTROLS";

export const UI_AA_PLOT_TOOLBOX_STAR_STYLE = "UI_AA_PLOT_TOOLBOX_STAR_STYLE";
export const UI_AA_PLOT_TOOLBOX_STAR_LOCALITY = "UI_AA_PLOT_TOOLBOX_STAR_LOCALITY";
export const UI_AA_PLOT_TOOLBOX_STAR_METALLICITY = "UI_AA_PLOT_TOOLBOX_STAR_METALLICITY";
export const UI_AA_PLOT_TOOLBOX_GRAPH_SETUP = "UI_AA_PLOT_TOOLBOX_GRAPH_SETUP";
export const UI_AA_PLOT_TOOLBOX_GRAPH_ID = "UI_AA_PLOT_TOOLBOX_ID";

export const UI_AA_PLOT_LOCALITY_SELECTMODE = "UI_AA_PLOT_LOCALITY_SELECTMODE";

export const UI_AA_PLOT_RENDERGRIDLINES = "UI_AA_PLOT_RENDERGRIDLINES";
export const UI_AA_PLOT_AXISLABELS = "UI_AA_PLOT_AXISLABELS";

export const UI_AA_PLOT_XPADDING = "UI_AA_PLOT_XPADDING";
export const UI_AA_PLOT_YPADDING = "UI_AA_PLOT_YPADDING";
export const UI_AA_PLOT_POINTSIZE = "UI_AA_PLOT_POINTSIZE";
export const UI_AA_PLOT_POINTOPACITY = "UI_AA_PLOT_POINTOPACITY";
export const UI_AA_SELECTED_OPACITY = "UI_AA_SELECTED_OPACITY";
...
export const UI_LIGHTING_SURFACE_FACTOR = "UI_LIGHTING_SURFACE_FACTOR";
export const UI_LIGHTING_SURFACE_LIGHTING_FACTOR = "UI_LIGHTING_SURFACE_LIGHTING_FACTOR";

export const UI_BLOCK_ZDEPTH = "UI_BLOCK_ZDEPTH";
...
export const UI_ORGANISM_GRASS_GRASS = "UI_ORGANISM_GRASS_GRASS";
export const UI_ORGANISM_GRASS_FGRASS = "UI_ORGANISM_GRASS_FGRASS";
...
export const UI_VIEWMODE_CAMERAMODE = "UI_VIEWMODE_CAMERAMODE";
...
export const UI_SPEED_ZERO = "UI_SPEED_ZERO";
export const UI_SPEED_ONE = "UI_SPEED_ONE";
export const UI_SPEED_TWO = "UI_SPEED_TWO";
export const UI_SPEED_THREE = "UI_SPEED_THREE";
export const UI_SPEED_FOUR = "UI_SPEED_FOUR";
export const UI_SPEED_FIVE = "UI_SPEED_FIVE";
export const UI_SPEED_SIX = "UI_SPEED_SIX";
export const UI_SPEED_SEVEN = "UI_SPEED_SEVEN";
...
export const UI_SPEEDS = [UI_SPEED, UI_SPEED_ZERO, UI_SPEED_ONE, UI_SPEED_TWO, UI_SPEED_THREE, UI_SPEED_FOUR, UI_SPEED_FIVE, UI_SPEED_SIX, UI_SPEED_SEVEN, UI_SPEED_8, UI_SPEED_9, UI_SPEED_10, UI_SPEED_11]; //, UI_SPEED_12]; //,UI_SPEED_13, UI_SPEED_14, UI_SPEED_15, UI_SPEED_16, UI_SPEED_17, UI_SPEED_18, UI_SPEED_19 ]
...
export const UI_PALETTE_SURFACE_LIGHTING_FACTOR = "UI_PALETTE_SURFACE_LIGHTING_FACTOR";
export const UI_PALETTE_SURFACE = "UI_PALETTE_SURFACE";

export const UI_PALETTE_SURFACE_LIGHTING_FACTOR_MATCH = "UI_PALETTE_SURFACE_LIGHTING_FACTOR_MATCH";
...
export const UI_PALETTE_CENTER_SELECT = "UI_PALETTE_CENTER_SELECT";
...
export let _GAMEDATA_DEFAULT = {
    ...
    UI_AA_PLOT_ACTIVE: 0,
    UI_AA_PLOT_WIDTH: 51.639439174107146,
    UI_AA_PLOT_HEIGHT: 41.99658203125,
    UI_AA_PLOT_ZOOM_X: 3,
    UI_AA_PLOT_ZOOM_Y: 3,
    UI_AA_PLOT_OFFSET_X: 0,
    UI_AA_PLOT_OFFSET_Y: 0,
    UI_AA_PLOT_MAXPOINTS: 1000,
    UI_AA_PLOT_XKEY: "magnitude",
    UI_AA_PLOT_YKEY: "bv",
    UI_AA_PLOT_POINTSIZE: 1,
    UI_AA_PLOT_POINTOPACITY: 1,
    UI_AA_PLOT_XPADDING: 25,
    UI_AA_PLOT_YPADDING: 25,
    UI_AA_SELECT_FILTERMODE_STARS: 0,
    UI_AA_SELECT_FILTERMODE_GRAPH: 0,
    UI_AA_LABEL_STARS: 0,
    UI_AA_LABEL_GRAPH: 0,
    UI_AA_PLOT_HIDEGRAPH: 0,
    UI_AA_PLOT_HIDECONTROLS: 0,
    UI_AA_PLOT_SELECTRADIUS: 20,
    UI_AA_PLOT_LOCALITY_SELECTMODE: 0,
    UI_AA_PLOT_TOOLBOX_STAR_STYLE: 0,
    UI_AA_SETUP_COLORMODE: "default",
    UI_AA_SETUP_MIN: 0,
    UI_AA_SETUP_WINDOW_SIZE: 1,
    UI_AA_SETUP_POW: 1,
    UI_AA_SETUP_MULT: 1,
    UI_AA_SETUP_SELECT_MULT: 1,
    
    // star sectors 
    UI_SH_STYLE_SIZE_A: 1.350723552488077,
    UI_SH_STYLE_SIZE_B: -2.192068652970473,
    UI_SH_STYLE_SIZE_C: 0.5,
    UI_SH_STYLE_BRIGHTNESS_A: 3.1333183844993187,
    UI_SH_STYLE_BRIGHTNESS_B: -0.8161899956049679,
    UI_SH_STYLE_BRIGHTNESS_C: 0.5,
    UI_SH_TARGETNUMSTARS: 5000,
    UI_SH_MINLUMINENCE: -17512.80219045445,
    UI_SH_MAXLUMINENCE: -89.91348137181669,
    UI_SH_BASESIZE: 23.73799646901336,
    UI_SH_DISTPOWERMULT: 1.312261330833456,
    UI_SH_MINSIZE: -20.850016817438267,
    UI_SH_MAXSIZE: -1.388147825957752,
    UI_SH_COLORSHIFT: 120,
    // lighting
    ...
    UI_TOPBAR: true,
    UI_SPEED: UI_SPEED_ONE,
    UI_CLIMATE_SELECT: UI_CLIMATE_MIDWEST,
    UI_SIMULATION_HEIGHT: 125,
    UI_LIGHTING_SURFACE: 0.7,
    UI_LIGHTING_SURFACE_FACTOR: 1,
    UI_LIGHTING_SURFACE_LIGHTING_FACTOR: 0.5,
    ...
    UI_SH_MINSIZE: 4,
    UI_SH_STYLE_SIZE_A: .04035,
    UI_SH_STYLE_BRIGHTNESS_B: 0.3851922,
    UI_SH_STYLE_SIZE_B: 2.24128,
    UI_SH_STYLE_BRIGHTNESS_A: -.436743,
    UI_STARMAP_ZOOM: 10,
    UI_STARMAP_PREV_ZOOM: 10,
    UI_STARMAP_STAR_CONTROL_TOGGLE_MODE: 0,
    UI_STARMAP_FEH_MIN_VALUE: -5,
    UI_STARMAP_FEH_WINDOW_SIZE: 1, 
    UI_STARMAP_FEH_POW: 1,
    UI_STARMAP_VIEWMODE: 0
};
